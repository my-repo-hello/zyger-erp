        ...
        <div className="panel">
          ...
          <div className="twrap">
            {loading ? <div className="empty"><span className="material-symbols-rounded">hourglass_empty</span> Loading...</div> : (
              <table className="tbl">
                <thead><tr><th>WTC No</th><th>Date</th><th>Meter</th><th>Opening</th><th>Closing</th><th>Consumption</th><th>Usage Type</th><th>Status</th><th>Actions</th></tr></thead>
                <tbody>
                  {filtered.length === 0 ? <tr><td colSpan={9}><div className="empty"><span className="material-symbols-rounded">description</span> No water entries.</div></td></tr> : filtered.map((r) => (
                    <tr key={r.id}>
